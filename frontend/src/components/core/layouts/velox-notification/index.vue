...
<template>
  <div
    class="velox-notification-panel velox-card-sm !shadow-xl"
    :style="{
  ...
  >
    ...
    <div class="w-full h-[calc(100%-95px)]">
      <div class="h-[calc(100%-60px)] overflow-y-scroll scrollbar-thin">
        ...
        >
          <VeloxSvgIcon icon="system-uicons:inbox" class="text-5xl" />
...
<script setup lang="ts">
  ...
  defineOptions({ name: 'VeloxNotification' })
