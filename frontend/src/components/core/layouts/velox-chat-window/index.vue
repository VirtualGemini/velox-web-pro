      ...
      <div class="flex h-[calc(100%-70px)] flex-col">
        ...
        <div class="px-4 pt-4">
          ...
          <div class="mt-3 flex-cb">
            <div class="flex-c">
              <VeloxSvgIcon icon="ri:image-line" class="mr-5 c-p text-g-600 text-lg" />
              <VeloxSvgIcon icon="ri:emotion-happy-line" class="mr-5 c-p text-g-600 text-lg" />
            </div>
...
<script setup lang="ts">
  ...
  defineOptions({ name: 'VeloxChatWindow' })
