...
CREATE TABLE `sys_mail_template` (
  ...
  `subject_zh` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Chinese subject (may contain {{var}})',
  `content_zh` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'Chinese HTML body (may contain {{var}})',
  `subject_en` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'English subject (may contain {{var}})',
  `content_en` mediumtext COLLATE utf8mb4_unicode_ci COMMENT 'English HTML body (may contain {{var}})',
