package com.velox.framework.web.common.servlet;

public final class WebFilterNames {
    ...
    public static final String SECURITY_HEADERS_FILTER = "securityHeadersFilter";
